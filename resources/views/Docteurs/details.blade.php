      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <h2>{{ $docteurs->nom }} {{ $docteurs->docteurs }}</h2>
          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-4 label">Prénom</div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-4 label">Sexe</div>
                  <div class="col-lg-9 col-md-8">{{ $docteurs->sexe }}</div>
                </div>

                <div class="row">
                    <div class="col-lg-6 col-md-4 label">Spécialité</div>
