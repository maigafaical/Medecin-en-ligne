        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card recent-sales overflow-auto">
              ...
              <form method="POST" action="{{route('docteurs.update', [$docteurs->id])}}" class="row g-3" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
              <div class="col-md-6">
              ...
              <div class="col-6">
                <label for="inputAddress5" class="form-label">Spécialité</label>
              ...
              <div class="col-6">
                ...
                <input type="text" class="form-control" name="telephone" value="{{ $docteurs->telephone}}">
              </div>
